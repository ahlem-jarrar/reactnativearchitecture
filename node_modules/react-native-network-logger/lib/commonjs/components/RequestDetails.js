...
const RequestDetails = ({
  ...
  const getFullRequest = () => {
    ...
    if (responseBody) {
      try {
        ...
        response = "".concat(responseBody);
      }
    }

    const processedRequest = _objectSpread(_objectSpread({}, request), {}, {
      response,
  ...
  }, "Request Body"), /*#__PURE__*/_react.default.createElement(LargeText, null, requestBody), /*#__PURE__*/_react.default.createElement(_Header.default, {
