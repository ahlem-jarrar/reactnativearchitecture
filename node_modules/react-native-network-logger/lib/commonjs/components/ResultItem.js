...
const ResultItem = ({
  ...
  const pad = num => "0".concat(num).slice(-2);
  ...
  return /*#__PURE__*/_react.default.createElement(MaybeTouchable, _extends({
    ...
    accessibilityLabel: "Method: ".concat(request.method)
  }, request.method), /*#__PURE__*/_react.default.createElement(_reactNative.Text, {
    style: [styles.status, getStatusStyles(request.status)],
    accessibilityLabel: "Response status ".concat(status)
  }, status), /*#__PURE__*/_react.default.createElement(_reactNative.Text, {
    style: styles.text
  }, request.duration > 0 ? "".concat(request.duration, "ms") : 'pending'), /*#__PURE__*/_react.default.createElement(_reactNative.Text, {
    style: styles.time
